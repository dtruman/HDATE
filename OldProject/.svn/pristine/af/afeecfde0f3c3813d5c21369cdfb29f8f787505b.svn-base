    ...
    class Player
    {
        ...
        public void assignStats()
        {
            while (numUnusedStatPoints > 0)
            {
                ...
                Console.WriteLine("Which would you like to increment?");
        ...
        public void CharacterCreation()
        {
            ...
            {
                EquippedWeapon = new Weapon(Items.Type.Bronze, WeaponType.Sword, 0, "A starting sword.");
            }
            else if (Intelligence > Strength && Intelligence > Dexterity)
            {
                EquippedWeapon = new Weapon(Items.Type.Bronze, WeaponType.Staff, 0, "A starting staff.");
            }
            else if (Dexterity > Intelligence && Dexterity > Strength)
            {
                EquippedWeapon = new Weapon(Items.Type.Bronze, WeaponType.Bow, 0, "A starting bow.");
            }
            else
            {
                EquippedWeapon = new Weapon(Items.Type.Bronze, WeaponType.Sword, 0, "A starting sword.");
            ...
            EquippedArmor = new Armor(Items.Type.Bronze, 0, "A starting set of armor.");
        }
